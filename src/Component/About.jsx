      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-8">
        ...
        <div className="md:w-1/2 flex items-center justify-center">
          <ProfileCard
            ...
            enableTilt={true}
            onContactClick={() =>
              window.open("https://wa.me/8801829774960", "_blank")
            }
          />
        </div>
        ...
        >
          ...
          <p className="mb-4">
            ...
            technology and innovation, with a particular interest in Full-Stack
            Web Development, Artificial Intelligence (AI), and Cybersecurity.
          </p>

          <h3 className="text-2xl font-bold mb-4 mt-6">Field of Interest</h3>
          <p className="mb-4">
            I am passionate about exploring cutting-edge technologies that solve
            real-world problems. My core areas of interest include:
          </p>
          ...
          <div className="grid grid-cols-2 gap-3 mt-4">
            ...
            <div className="flex items-center">
              <span className="mr-2">🛡️</span> Ethical Hacking & Cybersecurity
            </div>
            <div className="flex items-center">
          ...
          <p className="mb-4">
            I continuously improve and expand my technical toolkit. My current
            skill set includes:
          </p>

          <div className="grid grid-cols-2 gap-3 mt-4">
            <div className="flex items-center">
              <span className="mr-2">🧑‍💻</span> JavaScript, Python, C/C++, Java,
              SQL, 8086 Assembly
            </div>
            <div className="flex items-center">
              <span className="mr-2">⚙️</span> React.js, Node.js, Express.js,
              MongoDB, Firebase,
            </div>
            <div className="flex items-center">
